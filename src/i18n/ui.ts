...
const es = {
  ...
  story: {
    ...
    title: 'Una estrella de la Sala de los Reyes me enseñó el camino.',
    subtitle: 'Todavía no sé adónde lleva, y esa es la mejor parte.',
    p1: 'Mi primer jabón fue esta estrella. La copié de un azulejo de la Sala de los Reyes y, cuando salió del molde, entendí que no quería hacer un jabón: quería recorrer la Alhambra pieza a pieza. Desde entonces cada azulejo nuevo es un paso más, sin prisa por completar la serie.',
    p2: 'En mi taller de Granada no vendo jabones, sino experiencias sensoriales que llegan al alma a través de los sentidos. Respeto los tiempos de secado, aromatizo a la temperatura justa y cuido que cada tonalidad sea exacta. La vista, el olfato y el tacto están milimétricamente estudiados para que la experiencia sea cien por cien sensorial.',
    facts: [
      { n: '5', label: 'sentidos' },
      { n: '100%', label: 'hecho a mano' },
      { n: 'S. Nevada', label: 'aceites esenciales' },
    ],
    quote: '“El regalo no está al final del camino. Está en cada pieza que sale del molde.”',
    signature: 'Belén',
...
const en: typeof es = {
  ...
  story: {
    ...
    title: 'A star from the Hall of the Kings showed me the way.',
    subtitle: 'I still don’t know where it leads, and that is the best part.',
    p1: 'This star was my first soap. I copied it from a tile in the Hall of the Kings and, when it came out of the mould, I understood I did not want to make a soap: I wanted to walk the Alhambra piece by piece. Since then every new tile is one more step, with no hurry to finish the series.',
    p2: 'In my Granada workshop I do not sell soaps. I sell sensory experiences that reach the soul through the senses. I respect the drying times, add fragrance at just the right temperature and make sure every tone is exact. Sight, smell and touch are studied to the millimetre so the experience is one hundred percent sensory.',
    facts: [
      { n: '5', label: 'senses' },
      { n: '100%', label: 'handmade' },
      { n: 'S. Nevada', label: 'essential oils' },
    ],
    quote: '“The gift is not at the end of the road. It is in every piece that comes out of the mould.”',
    signature: 'Belén',
